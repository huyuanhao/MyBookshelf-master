...
class ReadAdjustMarginPop : FrameLayout {
    ...
    private fun bindEvent() = with(binding) {
        ...
        ivMrFAdd.setOnClickListener { hpbMrF.progress = hpbMrF.progress + 1 }
        ivMrFRemove.setOnClickListener { hpbMrF.progress = hpbMrF.progress - 1 }
        ...
        ivMrRmAdd.setOnClickListener { hpbMrRm.progress = hpbMrRm.progress + 1 }
        ivMrRmRemove.setOnClickListener { hpbMrRm.progress = hpbMrRm.progress - 1 }
        ...
        ivMrDmAdd.setOnClickListener { hpbMrDm.progress = hpbMrDm.progress + 1 }
        ivMrDmRemove.setOnClickListener { hpbMrDm.progress = hpbMrDm.progress - 1 }
        ...
        ivMrZTAdd.setOnClickListener { hpbMrZT.progress = hpbMrZT.progress + 1 }
        ivMrZTRemove.setOnClickListener { hpbMrZT.progress = hpbMrZT.progress - 1 }
        ivMrZLAdd.setOnClickListener { hpbMrZL.progress = hpbMrZL.progress + 1 }
        ivMrZLRemove.setOnClickListener { hpbMrZL.progress = hpbMrZL.progress - 1 }
        ivMrZRAdd.setOnClickListener { hpbMrZR.progress = hpbMrZR.progress + 1 }
        ivMrZRRemove.setOnClickListener { hpbMrZR.progress = hpbMrZR.progress - 1 }
        ivMrZBAdd.setOnClickListener { hpbMrZB.progress = hpbMrZB.progress + 1 }
        ivMrZBRemove.setOnClickListener { hpbMrZB.progress = hpbMrZB.progress - 1 }
        ivMrTTAdd.setOnClickListener { hpbMrTT.progress = hpbMrTT.progress + 1 }
        ivMrTTRemove.setOnClickListener { hpbMrTT.progress = hpbMrTT.progress - 1 }
        ivMrTLAdd.setOnClickListener { hpbMrTL.progress = hpbMrTL.progress + 1 }
        ivMrTLRemove.setOnClickListener { hpbMrTL.progress = hpbMrTL.progress - 1 }
        ivMrTRAdd.setOnClickListener { hpbMrTR.progress = hpbMrTR.progress + 1 }
        ivMrTRRemove.setOnClickListener { hpbMrTR.progress = hpbMrTR.progress - 1 }
        ivMrTBAdd.setOnClickListener { hpbMrTB.progress = hpbMrTB.progress + 1 }
        ivMrTBRemove.setOnClickListener { hpbMrTB.progress = hpbMrTB.progress - 1 }
    }
